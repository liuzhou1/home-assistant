...
class AmapPanel extends LitElement {
  ...
  initAmap() {
    ...
    let mapTheme = "amap://styles/";

    switch (theme) {
      case "ios-dark-mode-blue-red":
      case "ios-dark-mode-blue-red-alternative":
      case "ios-light-mode-blue-red":
      case "ios-light-mode-blue-red-alternative":
        mapTheme += "darkblue";
        break;
      case "ios-dark-mode-dark-blue":
      case "ios-dark-mode-dark-blue-alternative":
      case "ios-dark-mode-dark-green":
      case "ios-dark-mode-dark-green-alternative":
        mapTheme += "dark";
        break;
      case "ios-light-mode-dark-green":
      case "ios-light-mode-dark-green-alternative":
        mapTheme += "macaron";
        break;
      default:
        mapTheme += "normal";
  ...
  render() {
    const { hass, panel, narrow } = this;
    console.log(hass, narrow);
    return html`
      <meta
        name="viewport"
      ...
      <style include="ha-style style-element">
        ...
        .device-marker {
          ...
          font-size: 14px;
          border-radius: 50%;
          border: 1px solid var(--ha-marker-color, var(--default-primary-color));
          color: var(--primary-text-color);
          background-color: var(--primary-background-color);
        }
        iron-image {
      ...
      <ha-app-layout>
        ...
        <div class="input-card">
          <div class="input-item">
            <label>
              <input type="checkbox" on-click="${this.toggleTrafffic}" />
              实时路况
            </label>
          </div>
        </div>
