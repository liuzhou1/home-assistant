...
class WeatherCard extends LitElement {
  ...
  render() {
    ...
    if (last_updated !== this._last_updated) {
      ...
      attributes.hourly_temperature.map((daily, i) =>
        this.tempCOLOR.push(
          Math.round(
            255 *
              ((attributes.hourly_temperature[i].value - this.tempMIN) /
              ...
              <div class="forecast clear" @scroll="${this._hscroll}">
                ${attributes.hourly_temperature.map(
                  (daily, i) => html`
                    <div
                      class="hourly${i >
                      attributes.hourly_temperature.length - 5
                        ? " last5"
                        : ""} d${new Date(
                        attributes.hourly_temperature[i].datetime
                    ...
                    >
                      ...
                      <i
                        ...
                        attributes.hourly_skycon[i].value ==
                          attributes.hourly_skycon[i - 1].value
                          ? ""
                          : ", url(" +
                            iconUrl +
                            attributes.hourly_skycon[i].value +
                      ...
                      <span
                        style="border-top-color: rgb(${this.tempCOLOR[
                          i
                        ]});border-top-width:${((attributes.hourly_temperature[
                          i
                        ].value -
                          this.tempMIN) /
                          (this.tempMAX - this.tempMIN)) *
                      ...
                      >
                      <span
                        style="border-top-color: hsla(220, 100%, ${attributes
                          .hourly_cloudrate[i].value *
                          50 +
                        50}%, 1);"
                        class="cloudrate"
                        >.</span
                      ...
                      <span
                        style="border-top-color: hsla(195, 100%, ${(4.8 -
                          attributes.hourly_precipitation[i].value) *
                          (50 / 4.8) +
                        50}%, 1);"
                        class="precipitation"
                        >.</span
                ...
                <div class="show hourly showdata">
                  <span class="dayname"
                    >${new Date(
                      attributes.hourly_temperature[showdata].datetime
                    ).toLocaleTimeString(lang, {
                      month: "2-digit",
                      day: "2-digit",
                      hour: "numeric",
                  ...
                  <span class="dayname"
                    >${skycon2cn[
                      attributes.hourly_skycon[showdata].value
                    ]}</span
                  >
                  <span class="dtemp"
                    >${attributes.hourly_temperature[showdata]
                      .value}${this.getUnit("temperature")}</span
                  >
                  <span class="cloudrate"
                    >${attributes.hourly_cloudrate[showdata].value}</span
                  >
                  <span class="precipitation"
                    >${Math.round(
                      attributes.hourly_precipitation[showdata].value * 100
                    ) / 100}${this.getUnit("precipitation")}</span
                  >
                </div>
              </div>
      ...
      <div class="card-config">
        ...
        <div class="side-by-side">
          ...
          <ha-formfield label="详细预报">
            <ha-switch
              id="df"
              ?checked=${this.config.show_forecast}
              value="normal"
              name="style_mode"
          ...
          <ha-formfield label="小时预报">
            <ha-switch
              id="hf"
              ?checked=${this.config.houer_forecast}
              value="normal"
              name="style_mode"
              .configValue="${"houer_forecast"}"
              @change="${this._valueChanged}"
            ></ha-switch>
          </ha-formfield>
        </div>
        ...
        <datalist id="attributelist">
          ${Object.keys(attributes).map(
            (item) => html`
              <option value=${item}>
                ${this.hass.localize(`ui.card.weather.attributes.${item}`)}
              </option>
            `
          )}
        </datalist>
